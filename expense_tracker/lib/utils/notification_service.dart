...
class LocalNotificationService {
  ...
  static void showDailySchduledNotification(int? hour, int? minute) async {
    const AndroidNotificationDetails android = AndroidNotificationDetails(
    ...
    var scheduleTime = tz.TZDateTime(
      ...
      currentTime.month,
      currentTime.day,
      hour ?? currentTime.day,
      minute ?? currentTime.day,
    );
    ...
    if (scheduleTime.isBefore(currentTime)) {
      scheduleTime = scheduleTime.add(const Duration(seconds: 20));
